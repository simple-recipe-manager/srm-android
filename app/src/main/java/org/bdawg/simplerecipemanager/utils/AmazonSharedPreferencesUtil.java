 ...
 */
public class AmazonSharedPreferencesUtil {
    ...
    public static void wipe(SharedPreferences sharedPreferences) {
        AmazonSharedPreferencesUtil.storeValueInSharedPreferences(
    ...
    public static String getUidForDevice(SharedPreferences sharedPreferences) {
        return AmazonSharedPreferencesUtil.getValueFromSharedPreferences(
